...
const HeroImage = () => {
  return (
    <div className="flex flex-col flex-1 md:p-5 ">
      <div className="text-xl md:text-5xl  text-black  font-SpaceMono text-center my-3 md:my-12 italic font-bold ">
        About Me
      </div>
      <div className="flex md:p-5 font-lexend text-gray-500 font-medium ">
        <div className=" flex flex-col flex-1 p-5 gap-7 justify-center ">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-3 items-center">
              ...
              <p className="text-sm md:text-lg">+977 9766607321</p>
            </div>
            <div className="flex gap-3 items-center">
              <LuMail className="md:text-2xl" />
              <p className=" text-sm md:text-lg"> anjangautam095@gmail.com</p>
            </div>
          </div>
          <div className="flex text-2xl md:text-4xl gap-4 text-gray-600">
