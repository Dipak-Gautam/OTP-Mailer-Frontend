...
const Footer = () => {
  return (
    <div className="bg-[#f3f6fe] px-5 md:px-10 lg:px-24 flex py-8 md:py-12 justify-between">
      <div className="flex flex-col items-center gap-3 md:gap-8 cursor-pointer">
        <div className="w-fit">
