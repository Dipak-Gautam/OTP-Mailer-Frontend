...
const Footer = () => {
  return (
    <div className="bg-[#f3f6fe] px-24 flex py-12 justify-between">
      <div className="flex flex-col items-center gap-8">
        <div className="w-fit">
          <div className="border border-gray-700  rounded-full p-2 bg-gray-700">
            <TbNorthStar className="text-white text-6xl" />
          </div>
        </div>

        <div className="text-center text-xs md:text-base font-lexend font-medium ">
